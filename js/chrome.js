...
function send(data) {
	return new Promise(function(resolve, reject) {
		...
		xhr.setRequestHeader('Content-type', (data.hasOwnProperty('contentType') ? data.contentType : 'application/x-www-form-urlencoded'));
...
function interruptAndSend(data) {
	...
	return new Promise(function(resolve, reject) {
		...
		syncXhr.setRequestHeader('Content-type', (data.hasOwnProperty('contentType') ? data.contentType : 'application/x-www-form-urlencoded'));
...
function getIpsSettings() {
	...
	value = JSON.parse(divElement.innerHTML);
